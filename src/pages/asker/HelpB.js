...
const newStyle = `Rectangle211 w-[158.45px] h-[157px] left-0 top-0 absolute ${isClicked ? 'bg-customColor':'bg-white'} rounded-[20px] border-2 border-emerald-200`
    ...
    return (
        ...
        <div className="AskerHelpb w-[360px] h-[800px] relative bg-white">
            ...
            <div className=" w-[360px] h-[148px] left-0 top-0 absolute bg-white">
                ...
                <div className="ViewsProgressBars w-[314px] h-1 pr-[282.60px] left-[25px] top-[67px] absolute bg-gray-200 rounded-[100px] justify-start items-center inline-flex">
                ...
                <div className=" w-[271px] left-[47px] top-[91px] absolute text-neutral-950 text-[28px] font-bold leading-9">어떤 것을 도와드릴까요?</div>
            </div>

            {/* 스마트폰 및 태블릿 */}
           
            <div className="Smartphone w-[300px] h-[157px] left-[16px] top-[396px] absolute">
                <div className="Rectangle212 w-[160.06px] h-[157px] left-0 top-0 absolute bg-white rounded-[20px] border-2 border-emerald-200" />
            ...
            <div className="Group94 w-[281.57px] h-[158.60px] left-[186px] top-[215px] absolute">
                <div className="Rectangle213 w-[160.06px] h-[158.60px] left-0 top-0 absolute bg-white rounded-[20px] border-2 border-emerald-200" />
            ...
            <div className="Tv w-[301px] h-[157px] left-[186px] top-[396px] absolute">
                <div className="Rectangle215 w-[160.06px] h-[157px] left-0 top-0 absolute bg-white rounded-[20px] border-2 border-emerald-200" />
